...
def load_partition_data_mnist(batch_size,
    ...
    print("= = = = = = = = = = load_partition_data_mnist in data_loader.py = = = = = = = = = =")
    ...
    for u, g in zip(users, groups):
        ...
        # print('= = = = = = = = = = train in data_loader, client: ' + str(client_idx) + ' = = = = = = = = = =')
        # print(train_data_local_dict[client_idx])
    ...
    # print('= = = = = = = = = = train in data_loader, client: ' + str(1) + ' = = = = = = = = = =')
    # print(train_data_local_dict[1])
