...
class FedAVGTrainer(object):
    ...
    def train(self, round_idx = None):
        ...
        print(colorama.Fore.LIGHTGREEN_EX + '= = = = = = = = = = train in FedAVGTrainer, client_index:', str(self.client_index), 'train_local datalen:' + str(len(self.train_local)) + ' = = = = = = = = = =' + colorama.Style.RESET_ALL)
