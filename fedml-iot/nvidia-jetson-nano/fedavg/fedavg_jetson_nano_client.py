...
def init_training_device(process_ID, fl_worker_num, gpu_num_per_machine):
    ...
    logging.info("Process GPU dict:", process_gpu_dict)
...
if __name__ == '__main__':
    ...
    # start training
    trainer = FedAVGTrainer(client_ID, train_data_local_dict, train_data_local_num_dict, test_data_local_dict, train_data_num, device,
                            args, model_trainer)
